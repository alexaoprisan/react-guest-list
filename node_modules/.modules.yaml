...
hoistedDependencies:
  ...
  /eslint-plugin-jsx-expressions/1.3.2(@typescript-eslint/parser@6.15.0)(eslint@8.56.0)(typescript@5.3.3):
  ...
  /postcss-styled-syntax/0.6.2(postcss@8.4.33):
  ...
  /stylehacks/5.1.1(postcss@8.4.33):
    stylehacks: private
  /stylelint-config-css-modules/4.4.0(stylelint@16.2.0):
...
pendingBuilds: []
prunedAt: Thu, 25 Jan 2024 16:36:01 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/alexandraoprisan/Library/pnpm/store/v3
